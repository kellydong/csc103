...
/* TODO: read more about the call stack here (or at least look at the
 * pictures): https://www.cs.rutgers.edu/~pxk/419/notes/frames.html
 * */
 ...
 * Recently (last few years) subtle ways to read memory you shouldn't were
 ...
 * a bit of assembly!  You will likely need some help from the internet, but I
 * think if you're motivated, you'll be able to more or less decipher the
 * relevant pieces.  You can also try comparing the assembly code that has the
 * stack canary and the one that doesn't, but will take a bit of work to
